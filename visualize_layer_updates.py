...
plt.title(f"Layer-wise Parameter Adaptation - {run_name} (Round {start_round} $\\rightarrow$ {end_round})", fontsize=14, fontweight='bold')
plt.ylabel("Relative Change Norm $||\\Delta W|| / ||W||$", fontsize=12)
plt.grid(axis='y', linestyle='--', alpha=0.6)
plt.tight_layout()

os.makedirs("analysis_plots", exist_ok=True)
output_image = f"analysis_plots/{run_name}_layer_wise_updates.png"
