...
# WandB Logger
config.wandb_key = "32f110b8e14707dcb3d6873170687f466255d30f"
config.suffix_run_name = "dcface_1.3M_aug"
config.using_wandb = True 
config.wandb_entity = "ufpr_ic"
config.wandb_project = "Evaluation syhthetic facial data"
